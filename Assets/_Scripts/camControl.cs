...
public class camControl : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        transform.rotation = Quaternion.Euler(transform.rotation.eulerAngles.x, camHelper.rotation.eulerAngles.y, 0f);
        ...
        transform.position = playerBody.position - playerBody.forward * camOffset.z + playerBody.up * camOffset.y;
